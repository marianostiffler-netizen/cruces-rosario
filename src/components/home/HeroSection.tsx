export function HeroSection() {
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section - Realistic Forest Lake Background */}
      <section className="min-h-screen relative flex items-center justify-center pt-16 overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0" style={{
            backgroundImage: `linear-gradient(to top, rgba(34, 139, 34, 0.8) 0%, rgba(34, 139, 34, 0.4) 30%, transparent 60%)`,
          }}></div>
          
          {/* Lake reflection effect */}
          <div className="absolute bottom-0 left-0 right-0 h-1/2 bg-gradient-to-t from-blue-700/60 via-blue-600/40 to-transparent"></div>
          
          {/* Forest trees silhouettes */}
          <div className="absolute inset-0 opacity-30">
            <div className="absolute bottom-0 left-0 w-32 h-64 bg-green-900 rounded-t-full transform rotate-6"></div>
            <div className="absolute bottom-0 left-20 w-24 h-48 bg-green-800 rounded-t-full transform -rotate-3"></div>
            <div className="absolute bottom-0 left-40 w-28 h-56 bg-green-900 rounded-t-full transform rotate-2"></div>
            <div className="absolute bottom-0 right-0 w-36 h-60 bg-green-900 rounded-t-full transform -rotate-4"></div>
            <div className="absolute bottom-0 right-24 w-20 h-44 bg-green-800 rounded-t-full transform rotate-1"></div>
            <div className="absolute bottom-0 right-40 w-32 h-52 bg-green-900 rounded-t-full transform -rotate-2"></div>
            <div className="absolute bottom-0 left-1/4 w-24 h-40 bg-green-700 rounded-t-full"></div>
            <div className="absolute bottom-0 right-1/3 w-28 h-48 bg-green-800 rounded-t-full"></div>
          </div>
          
          {/* Mist/Fog effect over lake */}
          <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-white/20 via-white/10 to-transparent"></div>
          
          {/* Sunlight rays through trees */}
          <div className="absolute inset-0 opacity-20">
            <div className="absolute top-20 left-10 w-2 h-40 bg-yellow-300 transform rotate-45"></div>
            <div className="absolute top-32 right-20 w-1 h-60 bg-yellow-200 transform -rotate-12"></div>
            <div className="absolute top-16 left-1/3 w-1.5 h-50 bg-yellow-300 transform rotate-12"></div>
          </div>
        </div>

        <div className="relative z-10 text-center px-6">
          <h2 className="text-6xl md:text-8xl font-bold text-white mb-6 leading-tight drop-shadow-lg">
            NAVEGA HACIA
            <br />
            <span className="text-cyan-300">LAS ISLAS</span>
          </h2>
        ...
        {/* Natural lake bottom transition */}
      ...
      <section className="py-20 bg-gradient-to-b from-blue-50 to-cyan-50">
        <div className="max-w-7xl mx-auto px-6">
          <h3 className="text-4xl font-bold text-blue-900 text-center mb-12">Estado del Río</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-blue-100">
              ...
              <h4 className="text-2xl font-bold text-blue-900 mb-3">Nivel del Río</h4>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-blue-100">
              ...
              <h4 className="text-2xl font-bold text-blue-900 mb-3">Clima Actual</h4>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-blue-100">
              ...
              <h4 className="text-2xl font-bold text-blue-900 mb-3">Próxima Salida</h4>
              <p className="text-gray-600 mb-4">Puerto Norte - Isla del Inglés</p>
              <div className="flex items-center justify-between pt-4 border-t border-blue-100">
                <span className="text-sm text-gray-500">Copacidad</span>
      ...
      {/* Horarios Section */}
      <section id="horarios" className="py-20 bg-gradient-to-b from-cyan-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-6">
          <h3 className="text-4xl font-bold text-blue-900 text-center mb-12">Horarios de Salida</h3>
          
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-blue-100">
            <h4 className="text-2xl font-bold text-blue-900 mb-6">Taxi Lanchas - Salida Constante</h4>
            <div className="overflow-x-auto">
              <table className="w-full text-left">
                <thead>
                  <tr className="border-b border-blue-200">
                    <th className="py-3 px-4 font-semibold text-blue-900">Taxi Lancha</th>
                    <th className="py-3 px-4 font-semibold text-blue-900">Destino</th>
                    <th className="py-3 px-4 font-semibold text-blue-900">Frecuencia</th>
                    <th className="py-3 px-4 font-semibold text-blue-900">Duración</th>
                  </tr>
                </thead>
                <tbody>
      ...
      {/* Tarifas Section */}
      <section id="tarifas" className="py-20 bg-gradient-to-b from-blue-50 to-cyan-50">
        <div className="max-w-7xl mx-auto px-6">
          <h3 className="text-4xl font-bold text-blue-900 text-center mb-12">Tarifas de Taxi Lanchas</h3>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-blue-100">
              <h4 className="text-xl font-bold text-blue-900 mb-4">Pasajero</h4>
              <div className="space-y-3">
                <div className="flex justify-between">
                  <span className="text-gray-600">Ida</span>
                  <span className="font-semibold text-blue-900">$5.000</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Ida y Vuelta</span>
                  <span className="font-semibold text-blue-600 text-lg">$10.000</span>
                </div>
              </div>
            </div>

            <div className="bg-white rounded-2xl shadow-lg p-8 border border-blue-100">
              <h4 className="text-xl font-bold text-blue-900 mb-4">Vehículo</h4>
              <div className="space-y-3">
                <div className="flex justify-between">
                  <span className="text-gray-600">Moto</span>
                  <span className="font-semibold text-blue-900">$8.000</span>
                </div>
                <div className="flex justify-between">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-blue-100">
              <h4 className="text-xl font-bold text-blue-900 mb-4">Servicios</h4>
              <div className="space-y-3">
                <div className="flex justify-between">
      ...
      {/* Paradores Section */}
      <section id="paradores" className="py-20 bg-gradient-to-b from-cyan-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-6">
          <h3 className="text-4xl font-bold text-blue-900 text-center mb-12">Paradores</h3>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow border border-blue-100">
              <h4 className="text-xl font-bold text-blue-900 mb-3">Vladimir</h4>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow border border-blue-100">
              <h4 className="text-xl font-bold text-blue-900 mb-3">Garden</h4>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow border border-blue-100">
              <h4 className="text-xl font-bold text-blue-900 mb-3">El Muelle</h4>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow border border-blue-100">
              <h4 className="text-xl font-bold text-blue-900 mb-3">La Rueda</h4>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow border border-blue-100">
              <h4 className="text-xl font-bold text-blue-900 mb-3">Cabaña del Pescador</h4>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow border border-blue-100">
              <h4 className="text-xl font-bold text-blue-900 mb-3">Paraíso</h4>
